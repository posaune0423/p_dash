...
const getAccounts = async () => {
    if (
        ...
        import.meta.env.ACCOUNT_CLASS_HASH &&
        import.meta.env.MASTER_PUBLIC_KEY
    ) {
        return [
            {
                address: import.meta.env.MASTER_ADDRESS,
                balance: "1000000000000000000000",
                class_hash: import.meta.env.ACCOUNT_CLASS_HASH,
                private_key: import.meta.env.MASTER_PRIVATE_KEY,
                public_key: import.meta.env.MASTER_PUBLIC_KEY,
            },
        ];
    }
