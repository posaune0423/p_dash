...
type InterpretType = (appName: string, position: Coordinate, typeInstruction: string, abi: AbiType) => ParamDefinitionType

export const interpret: InterpretType = (appName: string, position: Coordinate, typeInstruction: string, abi: AbiType) => {
