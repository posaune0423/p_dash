...
export function defineContractComponents(world: World) {
  return {
    ...
    Pixel: (() => {
      return defineComponent(
        world,
        { x: RecsType.Number, y: RecsType.Number, app: RecsType.BigInt, color: RecsType.Number, created_at: RecsType.BigInt, updated_at: RecsType.BigInt, timestamp: RecsType.BigInt, owner: RecsType.BigInt, text: RecsType.BigInt, action: RecsType.BigInt },
        {
          metadata: {
            name: "pixelaw-Pixel",
