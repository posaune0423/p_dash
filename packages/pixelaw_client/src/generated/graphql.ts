...
export const AlertsDocument = gql`
    query alerts($first: Int) {
        events(first: $first, keys: ["0x4f01980329bc5de8cd181e4fb67fefefe583bd41f04365fa472ba112e7e5ef"]) {
            edges {
                node {
                    id
                    keys
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        ): Promise<{ data: AlertsQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number }> {
            return withWrapper(
