...
const defaultDojoConfig: DojoConfig = {
    relayUrl: import.meta.env.RELAY_URL || LOCAL_RELAY,
    rpcUrl: import.meta.env.RPC_URL || LOCAL_KATANA,
    toriiUrl: import.meta.env.TORII_URL || LOCAL_TORII,
    manifest,
    masterAddress: import.meta.env.MASTER_ADDRESS || KATANA_PREFUNDED_ADDRESS,
    masterPrivateKey: import.meta.env.MASTER_PRIVATE_KEY || KATANA_PREFUNDED_PRIVATE_KEY,
    accountClassHash: import.meta.env.ACCOUNT_CLASS_HASH || KATANA_CLASS_HASH,
    feeTokenAddress: import.meta.env.FEETOKEN_ADDRESS || KATANA_ETH_CONTRACT_ADDRESS,
};

const useDojoStore = create<
    DojoConfig &
        ClientState & {
