...
export interface InitOutput {
  ...
  readonly hashGetContractAddress: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly toriiclient_updateEntitySubscription: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly toriiclient_updateEventMessageSubscription: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h30748262f1b7d27c: (
    a: number,
    b: number,
    c: number,
  ) => void
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb74b4e0cfb480659: (
    a: number,
    b: number,
  ) => void
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcbe5adb8ab3b7d0e: (
    a: number,
    b: number,
    c: number,
  ) => void
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0616717051788241: (
    a: number,
    b: number,
    c: number,
  ) => void
  ...
  readonly wasm_bindgen__convert__closures__invoke2_mut__h3e82d67bb2b557d3: (
    a: number,
    b: number,
    c: number,
    d: number,
