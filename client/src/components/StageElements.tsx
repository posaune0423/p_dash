...
//     }
//     setIsLoading(false)
//   }, [activeAccount, router, stagesList, newStagePosition, stageId, currentBlocks, initializeStage, batchPutBlocks])
...
//               height={36}
//               alt="block"
//               className={cn(selectedElement === BlockType.Block && 'border-2 border-white/80 rounded-md')}
//               onClick={() => handleSelectElement(BlockType.Block)}
//             />
//           </div>
//           <div
...
//               height={36}
//               alt="tile"
//               className={cn(selectedElement === BlockType.Tile && 'border-2 border-white/80 rounded-md')}
//               onClick={() => handleSelectElement(BlockType.Tile)}
//             />
//           </div>
//           <div
